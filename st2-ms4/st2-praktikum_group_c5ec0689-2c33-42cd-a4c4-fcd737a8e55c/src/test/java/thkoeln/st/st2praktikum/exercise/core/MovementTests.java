...
public abstract class MovementTests extends GenericTests {
    ...
    protected void createWorld(CleaningDeviceService cleaningDeviceService, SpaceService spaceService, TransportCategoryService transportCategoryService) {
        ...
        connection1 = transportCategoryService.addConnection(transportCategory1, space1, Coordinate.fromString("(1,1)"), space2, Coordinate.fromString("(0,1)"));
        connection2 = transportCategoryService.addConnection(transportCategory1, space2, Coordinate.fromString("(1,0)"), space3, Coordinate.fromString("(2,2)"));
        connection3 = transportCategoryService.addConnection(transportCategory2, space3, Coordinate.fromString("(2,2)"), space2, Coordinate.fromString("(1,0)"));
    }
